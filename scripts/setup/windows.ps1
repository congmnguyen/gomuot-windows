# GoMuot Windows Development Setup Script
# Run: powershell -ExecutionPolicy Bypass -File scripts/setup/windows.ps1

Write-Host "GoMuot Windows Setup" -ForegroundColor Cyan
...
Write-Host "Build and package the Windows app with: 'powershell -ExecutionPolicy Bypass -File scripts/build/windows.ps1'" -ForegroundColor Cyan
