...
fn paragraph_telex() {
    ...
    // - "Docss" → "Docs" (double s escapes to English)
...
fn paragraph_vni() {
    ...
    // "Docs" stays as "Docs" in VNI because 's' is not a VNI modifier.
...
fn paragraph_smart_auto_restore() {
    ...
    let expected = "Chào các bạn, mình đang test Gõ Mượt. Smart auto restore: text, expect, perfect, window, with, their, wow, luxury, tesla, life, issue, feature, express, wonderful, support, core, care, saas, sax, push, work, hard, user. Per app memory: VS Code, Slack. Auto disable: Japanese, Korean, Chinese. Đắk Lắk, Đắk Nông, Krông Búk. Thanks for your wonderful support with this software.";
